...
// Ipagpapalagay ko na tama itong path sa images mo
import rentixLogo from './../../assets/RentixLogo.jpg';
import rentixName from './../../assets/RentixName.jpg';

export default function TenantLayout() {
  const location = useLocation();
  // Helper para ma-highlight kung anong page ang active sa sidebar
  ...
  return (
    <div className="d-flex min-vh-100 bg-light" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      >
        ...
        {/* Navigation Links - PINAGSAMA-SAMA NA LAHAT DITO */}
        <div className="d-flex flex-column gap-2 p-3 flex-grow-1">
          ...
          {/* IDINAGDAG DITO ANG HELP & REPORTS PARA MAGKAKASUNOD */}
          <Link 
            to="/tenant/help" 
      ...
      <div className="flex-grow-1 d-flex flex-column">
        ...
        <header className="d-flex justify-content-between align-items-center px-4 py-3 bg-white border-bottom shadow-sm position-sticky top-0" style={{ zIndex: 50 }}>
          <div className="fw-bold text-dark" style={{ fontSize: '18px' }}>
            {/* INAYOS NA DYNAMIC TITLE: Isinama na ang Maintenance at Help! */}
            ...
            <div className="d-flex align-items-center gap-3 border-start ps-3">
              <div className="d-flex align-items-center gap-2">
                <div
                  ...
                  style={{ width: '35px', height: '35px', fontSize: '13px', backgroundColor: '#0ea5e9' }}>
                  JL
                </div>
                <div className="d-flex flex-column">
                  <span className="fw-bold text-dark" style={{ fontSize: '13px', lineHeight: '1' }}>User</span>
                  <span className="text-muted" style={{ fontSize: '11px' }}>Tenant</span>
                </div>
              </div>

              <Link to="/login" className="btn btn-outline-danger btn-sm rounded-pill px-3 fw-semibold ms-2 d-flex align-items-center gap-1">
